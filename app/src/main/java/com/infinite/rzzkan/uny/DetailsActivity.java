...
import com.infinite.rzzkan.uny.Adapter.CommentAdapter;
...
public class DetailsActivity extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener {
    private static String GOOGLE_YOUTUBE_API = "AIzaSyCE8t1cq2plkWkrftYW6qMUF6FI6xaCGi8";
    private VideoModel youtubeDataModel = null;
    TextView textViewName;
    TextView textViewDes;
    TextView textViewDate;
    // ImageView imageViewIcon;
    public static final String VIDEO_ID = "w8sqokIhZqg";
    private YouTubePlayerView mYoutubePlayerView = null;
    private YouTubePlayer mYoutubePlayer = null;
    private ArrayList<CommentModel> mListData = new ArrayList<>();
...
//    }
    ...
    public void initVideoList(ArrayList<CommentModel> mListData) {
    ...
    public ArrayList<CommentModel> parseJson(JSONObject jsonObject) {
        ArrayList<CommentModel> mList = new ArrayList<>();
        ...
        if (jsonObject.has("items")) {
            try {
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    CommentModel youtubeObject = new CommentModel();
